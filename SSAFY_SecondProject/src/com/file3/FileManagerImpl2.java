...
public class FileManagerImpl2 implements FileManager{
	ArrayList<File> playList;

	// Singleton Pattern
	private static FileManagerImpl2 instance;
	private FileManagerImpl2(){
		playList = new ArrayList<>();
	}
	public static FileManagerImpl2 getInstance() {
		if(instance == null) {
			instance = new FileManagerImpl2();
		}
		return instance;
	}
	// Singleton Pattern
